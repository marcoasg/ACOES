...
public class Perfil extends JFrame {
	...
	public Perfil(Usuario u) {
		...
		lblCdigoPostal.setBounds(10, 176, 100, 14);
		contentPane.add(lblCdigoPostal);
		
		label_7 = new JLabel("");
		label_7.setBounds(167, 176, 257, 14);
		...
		lblTelfonoFijo.setBounds(10, 201, 100, 14);
		contentPane.add(lblTelfonoFijo);
		
		label_8 = new JLabel("");
		label_8.setBounds(167, 201, 257, 14);
		...
		lblTelfonoMvil.setBounds(10, 226, 100, 14);
		contentPane.add(lblTelfonoMvil);
		
		label_9 = new JLabel("");
		label_9.setBounds(167, 226, 257, 14);
		contentPane.add(label_9);
		label_9.setText(user.getTelefonoMovil());
		
		lblEmail = new JLabel("e-mail:");
		lblEmail.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblEmail.setBounds(10, 251, 100, 14);
		contentPane.add(lblEmail);
		
		label_10 = new JLabel("");
		label_10.setBounds(167, 251, 257, 14);
